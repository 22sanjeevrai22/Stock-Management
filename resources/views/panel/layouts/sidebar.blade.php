            ...
            <ul>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('category.index') }}"><i data-feather="codepen"></i><span>Category</span></a></li>
                        ...
                        <li><a href="{{ route('variation.index') }}"><i data-feather="layers"></i><span>Variant Attributes</span></a></li>
